...
guiMercury.add(controls, 'mercuryRotationSpeed', 0, 1).name('Rotation Speed');
guiMercury.add(controls, 'mercuryOrbitSpeed', 0, 1).name('Orbit Speed');

const guiVenus = gui.addFolder('Venus');
guiVenus.add(controls, 'venusRotationSpeed', 0, 1).name('Rotation Speed');
guiVenus.add(controls, 'venusOrbitSpeed', 0, 1).name('Orbit Speed');

const guiEarth = gui.addFolder('Earth');
guiEarth.add(controls, 'earthRotationSpeed', 0, 1).name('Rotation Speed');
guiEarth.add(controls, 'earthOrbitSpeed', 0, 1).name('Orbit Speed');

const guiMars = gui.addFolder('Mars');
guiMars.add(controls, 'marsRotationSpeed', 0, 1).name('Rotation Speed');
guiMars.add(controls, 'marsOrbitSpeed', 0, 1).name('Orbit Speed');
